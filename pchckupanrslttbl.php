...
<body>
  ...
  <?php
    ...
    $patient_regNum=$_SESSION['patient_regNum'];
      ...
      $srchcheckupsmpl = "SELECT * FROM sample_reslt WHERE patient_regNum='$patient_regNum' AND activations='1' ORDER BY clt_date";
  ...
  ?>
    ...
    <section class="app-body dynemics" id="Register">
      ...
      <div class="sectionContainer">
        ...
        <div class="chcktd">
          ...
          <div class="btnbr">
            ...
            <div class="btn_main">
              ...
              <button class="btn Proceed" style="background-color:rgba(194, 192, 192, 0.452);"><i class="fa fa-list-alt fa-1.5x"></i>&nbsp;&nbsp;priscription</button>
            ...
            <div class="btn_main">
              ...
              <button class="btn Proceed" style="background-color:rgba(194, 192, 192, 0.452);"><i class="fa fa-exclamation-circle fa-1.5x"></i>&nbsp;&nbsp;instructions</button>
        ...
        <div class="pchckripcon">
          
          <div class="advrdv">

            <div class="imgcnt">
              <a>My CheckUp Result</a>
            </div>
            ...
            <div class="Clndtcndn">
                ...
                <div class="collsample">
                    ...
                    <?php while($row1 = mysqli_fetch_array($smplelst)):;?>
                        ...
                        <td class="DownTry">
                            <a href="./crd/Download.php?pfile_id=<?php echo $row1[0]; ?>&prgnum=<?php echo $patient_regNum; ?>"><i class="fa fa-download fa-2x"></i></a>
                        </td>
                        </tr>
                    <?php endwhile;?>
                    </table>
