...
<body>
  ...
  <?php
    ...
    $srchongocln = "SELECT * FROM patient_passbook WHERE patient_regNum='$patient_regNum' AND chck_activat='1' IS NOT NULL";
    $ppris = mysqli_query($conn, $srchongocln);
        ...
        <div class="chcktd">
          ...
          <div class="btnbr">
            ...
            <div class="btn_main">
              ...
              <button class="btn Proceed" style="background-color:rgba(194, 192, 192, 0.452);"><i class="fa fa-flask fa-1.5x"></i>&nbsp;&nbsp;CheckUPS</button>
          ...
          <div class="dttdv">
            ...
            <div class="Clndtcndn">
              ...
              <div class="prscrpbr">
                ...
                <?php while($row1 = mysqli_fetch_array($ppris)):;?>
                  <textarea type="text" id="lstmed" name="lstmed" placeholder="List of Medicine" readonly><?php echo $row1[9]; ?></textarea>
                <?php endwhile;?>
              ...
              <div class="textbr">
                ...
                <button class="btn Proceed" onclick="location.href='http://localhost/ClinicButler/pchckupanrslttbl.php';"><i class="fa fa-bars fa-1.5x"></i>&nbsp;&nbsp;CleckUP Result</button>
