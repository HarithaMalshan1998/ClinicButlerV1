...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 23, 2020 at 06:38 AM
...
('003', '5248', '2020-09-21', '13:00:00', '15:00:00', 'HARITHA-007', 1, 1, 7, 1);
...
INSERT INTO `section_staff` (`section_ID`, `section_user_name`, `section_password`, `emp_activation`, `emp_id`, `emp_NIC`, `emp_name`) VALUES
('002', 'Dispensary@gmail.com', '1234', 1, '123', '251325421V', 'aaa'),
('001', 'Laboratory@gmail.com', '1234', 1, '456', '326521548V', 'sss'),
('003', 'Regch@gmail.com', '1234', 1, '789', '1296532652V', 'ddd');
...
ALTER TABLE `section_staff`
  ADD PRIMARY KEY (`emp_id`,`emp_NIC`) USING BTREE,
