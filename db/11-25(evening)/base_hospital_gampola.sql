...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 25, 2020 at 11:12 AM
...
(26, '2020-11-25', '16:00:00', '17:00:00', '001', '5248', 1, 1, 'CLN/G/1', 1),
(27, '2020-11-25', '16:30:00', '17:00:00', '001', '5248', 1, 1, 'CLN/G/1', 1),
(28, '2020-11-26', '18:00:00', '20:00:00', '001', '5248', 1, 1, 'CLN/G/1', 1);
...
('9016', 'HARITHA MALSHAN EDIRISINGHE', '982041562v', '1998-07-22', '', 765403320, 0, 'harithamalshan1998@gmail.com', '81dc9bdb52d04dc20036dbd8313ed055', 'Haritha edirisinghe,kaluthara,mathugama,welipanna,lewwanduwa');
...
(14, '9016', '5248', '001', '2020-11-07', '', 'dsfsdf', 'sdfsdfdd', 'wwwwwwwwwww', 'ecg', '2020-11-24', 1);
...
--
-- Dumping data for table `sample_reslt`
--

INSERT INTO `sample_reslt` (`id`, `patient_regNum`, `clinic_id`, `clt_date`, `pay_typ`, `checkup_name`, `file_Nme`, `activations`, `upload`) VALUES
(9, '9016', '001', '2020-11-24', 0, 'ecg', 'P1011594.JPG', 1, 1);
...
('6666', '666666666V', 'Priyantha Edirisinghe', 'MAIL', '2020-10-01', 342216528, NULL, 'info@gmail.com', '81dc9bdb52d04dc20036dbd8313ed055', '006', 1);
...
ALTER TABLE `sample_reslt`
  ADD PRIMARY KEY (`id`),
  ADD KEY `clinic_id` (`clinic_id`),
  ADD KEY `patient_regNum` (`patient_regNum`);
...
ALTER TABLE `sample_reslt`
  ...
  ADD CONSTRAINT `sample_reslt_ibfk_3` FOREIGN KEY (`patient_regNum`) REFERENCES `patient_data` (`patient_regNum`) ON DELETE CASCADE ON UPDATE CASCADE;
