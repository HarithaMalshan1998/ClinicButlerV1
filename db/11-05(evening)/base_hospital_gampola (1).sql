...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 05, 2020 at 01:56 PM
...
(26, '2020-11-02', '09:00:00', '12:00:00', '001', '5248', 1, 1, 'CLN/G/1', 1);
...
(3, '9016', '5248', '001', '2020-10-24', NULL, 'BP-114/80\r\n\r\nTotal-chol-134\r\n-> HDL-49\r\n-> TGL-61\r\n-> LDL-72\r\n-> Rat0.2.7\r\nFT3-1.57(3.39-6.47) FTY4.1.6\r\nTSH-3.49(0.3-3.6)\r\n\r\n FBS-176mg/dl.\r\n P.P.Bs-260.', 'controal fast food and do not do hard work. Take your medicines properly', '120-Glicaide-160mg-BD(1/12)\r\n120-Metformin-1g-BD(1/12)', 'ECG', 1);
...
(9, '9016', '001', '2020-11-02', 0, 'ecg', '', 1, 0),
(11, '9016', '001', '2020-11-02', 0, 'height', '', 1, 0);
...
--
ALTER TABLE `patient_date`
  MODIFY `clinic_date_indx` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
